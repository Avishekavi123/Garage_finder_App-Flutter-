...
class loginpage1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    TextEditingController login_user_controller = TextEditingController();
    TextEditingController login_user_password_controller = TextEditingController();
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: TextField(
                  controller: login_user_controller,
              ...
              Padding(
                padding: EdgeInsets.all(10),
                child: TextField(
                  controller: login_user_password_controller,
              ...
              Container(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async{
                   var loginemail_user=login_user_controller.text.trim();
                   var loginpass_user=login_user_password_controller.text.trim();
